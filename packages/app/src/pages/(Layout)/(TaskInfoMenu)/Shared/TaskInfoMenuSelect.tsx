...
export default function TaskInfoMenuSelect({ name, value, onChange, options }: TaskInfoSelect){
    return (
        <div className="flex flex-col gap-2">
          ...
          <select
            className="appearance-none w-full h-full text-base px-2 py-2 bg-silver-200 border border-accent-blue/20 rounded-lg text-primary overflow-x-hidden overflow-y-scroll dark:bg-[#253350]"
            value={value}
            onChange={onChange}
          >
